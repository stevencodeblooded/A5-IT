  ...
  return (
    <div className="px-3 pb-20">
      <section className="max-w-6xl mx-auto">
        <div>
          <h2 className="text-black text-3xl font-semibold mb-5">
            Related Products
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12">
            <div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <button className="bg-blue-600 hover:bg-blue-700 transition-all w-fit px-5 py-2 text-xs rounded-full text-white font-semibold border-none">
                  Add to Cart
                </button>
              </div>
            </div>
